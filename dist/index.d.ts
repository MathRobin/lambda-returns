...
export type { AcceptedLambdaResponse, BadGatewayLambdaResponse, BadRequestLambdaResponse, BandwidthLimitExceededLambdaResponse, ConflictLambdaResponse, CreatedLambdaResponse, ExpectationFailedLambdaResponse, FailedDependencyLambdaResponse, ForbiddenLambdaResponse, GatewayTimeOutLambdaResponse, GoneLambdaResponse, HttpContinueLambdaResponse, HttpHeaders, HttpVersionNotSupportedLambdaResponse, ImATeapotLambdaResponse, InsufficientStorageLambdaResponse, InternalServerErrorLambdaResponse, LambdaResponse, LengthRequiredLambdaResponse, LockedLambdaResponse, MethodNotAllowedLambdaResponse, MovedPermanentlyLambdaResponse, MovedTemporarilyLambdaResponse, MultiStatusLambdaResponse, MultipleChoicesLambdaResponse, NetworkAuthenticationRequiredLambdaResponse, NoContentLambdaResponse, NonAuthoritativeInformationLambdaResponse, NotAcceptableLambdaResponse, NotExtendedLambdaResponse, NotFoundLambdaResponse, NotImplementedLambdaResponse, NotModifiedLambdaResponse, OkLambdaResponse, PartialContentLambdaResponse, PaymentRequiredLambdaResponse, PreconditionFailedLambdaResponse, PreconditionRequiredLambdaResponse, ProcessingLambdaResponse, ProxyAuthenticationRequiredLambdaResponse, RequestEntityTooLargeLambdaResponse, RequestHeaderFieldsTooLargeLambdaResponse, RequestTimeOutLambdaResponse, RequestUriTooLargeLambdaResponse, RequestedRangeNotSatisfiableLambdaResponse, ResetContentLambdaResponse, SeeOtherLambdaResponse, ServiceUnavailableLambdaResponse, SwitchingProtocolsLambdaResponse, TemporaryRedirectLambdaResponse, TooManyRequestsLambdaResponse, UnauthorizedLambdaResponse, UnorderedCollectionLambdaResponse, UnprocessableEntityLambdaResponse, UnsupportedMediaTypeLambdaResponse, UpgradeRequiredLambdaResponse, UseProxyLambdaResponse, VariantAlsoNegotiatesLambdaResponse };

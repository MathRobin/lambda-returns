...
describe('continue', () => {
  ...
  test('should return 100 when has string body & headers', () => {
    expect(
      httpContinue('{"status":"success"}', { ContentType: 'application/json' })
    ).toEqual({
      statusCode: 100,
      headers: { ContentType: 'application/json' },
      body: '{"status":"success"}',
...
describe('processing', () => {
  ...
  test('should return 102 when empty body but headers filled', () => {
    expect(processing(undefined, { ContentType: 'application/json' })).toEqual({
      statusCode: 102,
      headers: { ContentType: 'application/json' },
      body: null,
    });
...
describe('resetContent', () => {
  ...
  test('should return 205 when has string body & headers', () => {
    expect(
      resetContent('{"status":"success"}', { ContentType: 'application/json' })
    ).toEqual({
      statusCode: 205,
      headers: { ContentType: 'application/json' },
      body: '{"status":"success"}',
...
describe('multiStatus', () => {
  ...
  test('should return 207 when empty body but headers filled', () => {
    expect(multiStatus(undefined, { ContentType: 'application/json' })).toEqual(
      {
        statusCode: 207,
        headers: { ContentType: 'application/json' },
        body: null,
...
describe('notModified', () => {
  ...
  test('should return 304 when empty body but headers filled', () => {
    expect(notModified(undefined, { ContentType: 'application/json' })).toEqual(
      {
        statusCode: 304,
        headers: { ContentType: 'application/json' },
        body: null,
...
describe('badRequest', () => {
  ...
  test('should return 400 when empty body but headers filled', () => {
    expect(badRequest(undefined, { ContentType: 'application/json' })).toEqual({
      statusCode: 400,
      headers: { ContentType: 'application/json' },
      body: null,
    });
...
describe('unauthorized', () => {
  ...
  test('should return 401 when has string body & headers', () => {
    expect(
      unauthorized('{"status":"success"}', { ContentType: 'application/json' })
    ).toEqual({
      statusCode: 401,
      headers: { ContentType: 'application/json' },
      body: '{"status":"success"}',
...
describe('notAcceptable', () => {
  ...
  test('should return 406 when has string body & headers', () => {
    expect(
      notAcceptable('{"status":"success"}', { ContentType: 'application/json' })
    ).toEqual({
      statusCode: 406,
      headers: { ContentType: 'application/json' },
      body: '{"status":"success"}',
...
describe('badGateway', () => {
  ...
  test('should return 502 when empty body but headers filled', () => {
    expect(badGateway(undefined, { ContentType: 'application/json' })).toEqual({
      statusCode: 502,
      headers: { ContentType: 'application/json' },
      body: null,
    });
...
describe('notExtended', () => {
  ...
  test('should return 510 when empty body but headers filled', () => {
    expect(notExtended(undefined, { ContentType: 'application/json' })).toEqual(
      {
        statusCode: 510,
        headers: { ContentType: 'application/json' },
        body: null,
